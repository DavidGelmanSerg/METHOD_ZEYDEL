...
double TForm1::norm(int m,double *pr)
 ...
 //---------------------------------------------------------------------------
int m ,n; // переменные размерности матрицы
...
{                                                    //чтение матрицы и вектора столбца b,												 //вывод матриц и вектора столбца на форму
   Memo1->Lines->Clear();
   Memo2->Lines->Clear();
...
int  kron;
   ...
   double P = StrToFloat(Edit2->Text);//считывание погрешности из поля
   for(int i=0;i<m;i++)
   {
	x[i]=1.0; //задание начальных приближений
   }
//!--------------------------------подсчет вектора столбца x------------------!
 double res=0;
  do
   {
       for(int i=0;i<m;i++)
